...
const displayalbum = () => {
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-3 sm:grid-cols-[1fr_0.5fr_0.5fr_0.5fr] mt-10 mb-4 pl-2 text-[#B3B3B3]">
                <p>
                    <b className="mr-4">#</b>Tiêu đề
                </p>
                <p className="ml-5">Album</p>
            ...
            {songsData.map((item, index) => (
                <div
                    ...
                    key={index}
                    className="grid grid-cols-3 sm:grid-cols-[1fr_0.5fr_0.5fr_0.5fr] gap-2 p-2 items-center text-[#B3B3B3] hover:bg-[#ffffff26] cursor-pointer"
                >
                    ...
                    <p className="text-[15px] m-auto">{radioData.name}</p>
