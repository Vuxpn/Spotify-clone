        ...
        <div className="w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex">
            <div className="bg-[#121212] h-[20%] rounded flex flex-col justify-around">
                <div className="flex items-center gap-3 pl-4 cursor-pointer">
                    ...
                    <p className="font-bold">English For Life -Admin</p>
                </div>
                <div className="flex items-center gap-3 pl-4 cursor-pointer ">
            ...
            <div className="bg-[#121212] h-[80%] rounded ">
                ...
                <div className="flex flex-col gap-5 mt-4">
                    ...
                    `}
                    >
                        <img className="w-8 p-1 bg-white rounded" src={assetsadmin.add_song} alt="" />
                        <p className="hidden sm:block font-semibold">Thêm audio</p>
                    ...
                    <NavLink
                        ...
                        `}
                    >
                        <img className="w-8 p-1 bg-white rounded" src={assetsadmin.list_song} alt="" />
                        <p className="hidden sm:block font-semibold">Hiển thị audio</p>
                        <img className="w-5 ml-auto" src={assets.arrow_icon} alt="" />
                    </NavLink>
                    ...
                    >
                        <img className="w-8 p-1 bg-white rounded" src={assetsadmin.list_radio} alt="" />
                        <p className="hidden sm:block font-semibold">Thêm video</p>
                        <img className="w-5 ml-auto" src={assets.arrow_icon} alt="" />
                    </NavLink>
                    <NavLink
                        to="/list-youtube"
                    ...
                    >
                        <img className="w-8 p-1 bg-white rounded" src={assetsadmin.list_radio} alt="" />
                        <p className="hidden sm:block font-semibold">Hiển thị video</p>
                        <img className="w-5 ml-auto" src={assets.arrow_icon} alt="" />
                    </NavLink>
                </div>
            </div>
